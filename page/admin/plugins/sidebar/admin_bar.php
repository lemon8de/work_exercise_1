        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-is-opening menu-open">
                ...
                <ul class="nav nav-treeview" style="display: block;">
                    <li class="nav-item">
                        <a href="view.php" class="nav-link"><i class="fas fa-book nav-icon"></i><p>View</p></a>
                    </li>
                    <li class="nav-item">
                        <a href="create.php" class="nav-link"><i class="fas fa-plus nav-icon"></i><p>Create</p></a>
                    </li>
                    <li class="nav-item">
                        <a href="dismiss.php" class="nav-link"><i class="fas fa-times nav-icon"></i><p>Dismiss</p></a>
                    </li>
                </ul>
            </li>
